...
import { addMember, deleteMember, editMember, getAllMembers, getLatestMemberId, getMember } from "../controllers/member.controller.js"
...
router.put("/editMember", validateToken(), isManager(), editMember)
